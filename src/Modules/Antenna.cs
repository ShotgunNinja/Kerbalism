  ...
  public override void OnStart(StartState state)
  {
    ...
    if (Lib.IsFlight())
    {
      ...
      if (anim != null)
      {
        ...
        anim.Events["DeployModule"].guiActiveUncommand = Settings.UnlinkedControl != UnlinkedCtrl.none;
        anim.Events["RetractModule"].guiActiveUncommand = Settings.UnlinkedControl != UnlinkedCtrl.none;
      }
    }
  }
