...
public static class Settings
{
  ...
  public static float  AtmosphereDecay;                   // if true, orbits in the atmosphere will decay
  public static float  RTGDecay;                          // if true, radioisotope thermoelectric generator output will decay
}
